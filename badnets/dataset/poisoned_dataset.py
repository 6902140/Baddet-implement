...
class TriggerHandler(object): 
    ...
    def put_trigger(self, img): # 添加trigger觸發器
...
class CIFAR10Poison(CIFAR10):
    ...
    def __init__(
        ...
        target_transform: Optional[Callable] = None, # target-transform 核心,變換目標進行投毒
        download: bool = False,
    ) -> None:
    ...
    def __getitem__(self, index): #可以直接根據對象和索引獲取圖片
